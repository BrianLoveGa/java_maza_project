...
/**
 * This is the Maze.Maze class. It has all of the methods and information needed
 ...
 * move through a wall or a pit Maze.Maze throws an exception and terminates the program.
...
public class Maze {
    ...
    /**
     * Instantiate a new Maze.Maze object.
     */
    public Maze() {
        row = 1;
        col = 0;
